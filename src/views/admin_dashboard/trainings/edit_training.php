                    ...
                    <div class="row p-3">
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="title" value="<?php echo $row['video_title']; ?>" name="title" aria-describedby="title">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="mb-5">
                                ...
                                <textarea type="text" rows="8" class="form-control" id="description" name="description" aria-describedby="description"><?php echo $row['video_description'] ?></textarea>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="mb-5">
                                <input class="btn btn-primary" type="submit" name="edit_video" value="Save Changes" onclick="showDiv()">
                            </div>
                        </div>
